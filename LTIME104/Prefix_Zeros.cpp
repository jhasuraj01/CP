...
long long int range(long long n, long long limit) {
    long long first = 10ll - n;
    return first + 10ll * ((long long) ((limit - first) / 10ll));
}
